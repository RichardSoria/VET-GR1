    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/6 px-4 py-20 border-custom-light-blue border-r-8'
                ...
                <p className='text-black text-center my-4 text-lg '> <span className='bg-green-600 w-3 h-3 inline-block rounded-full'></span> Bienvenido - {auth?.nombre}</p>
                ...
                <ul className="mt-5">
                    ...
                    <li className="text-center">
                        <Link to='/dashboard/crear' className={`${urlActual === '/dashboard/crear' ? 'text-white font-bold bg-custom-yellow p-2 rounded-md text-center' : 'text-black font-bold'} text-xl block mt-2 hover:bg-custom-red hover:text-white rounded-md p-2`}>Gestionar Corredores</Link>
                    </li>

                    <li className="text-center">
                        <Link to='/dashboard/listar' className={`${urlActual === '/dashboard/listar' ? 'text-white font-bold bg-custom-yellow p-2 rounded-md text-center' : 'text- font-bold'} text-xl block mt-2 hover:bg-custom-red hover:text-white rounded-md p-2`}>Gestionar Paradas y Rutas</Link>
                    </li>
                </ul>
            </div>
            ...
            <div className='flex-1 flex flex-col justify-between h-screen'>
                ...
                <div className='h-16 bg-custom-blue' />
            </div>
        </div>
    )
}
