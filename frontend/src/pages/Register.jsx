...
export const Register = () => {
    ...
    return (
        <>
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubnit}>
                        <div className="mb-3">
                            ...
                            placeholder="Ingresa tu nombre" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            placeholder="Ingresa tu apellido" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            placeholder="Ingresa tu dirección" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            placeholder="Ingresa tu teléfono" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            placeholder="Ingresa tu email" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            placeholder="********************" className="block w-full rounded-md border border-gray-300 focus:border-custom-light-blue focus:outline-none focus:ring-1 focus:ring-custom-light-blue py-1 px-2 text-gray-500" required />
                        </div>
            ...
            <div className="w-1/2 h-screen bg-[url('/public/images/20201119_083024.jpg')] 
